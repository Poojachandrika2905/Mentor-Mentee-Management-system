...
<body>
    ...
    <!-- Main Section with Sidebar Buttons and Mentee Cards -->
    <div class="main-section">
        ...
        <!-- Mentees List Cards -->
        <div class="course-card" role="region" aria-label="Mentees List">
            <%
                ...
                try {
                    ...
                    String query = "SELECT mentee_name FROM mentors WHERE mentor_name = ?";
            ...
            %>
                        <div class="btn1">
                            ...
                            <form action="selectMentee.jsp" method="post" style="margin-left:auto;">
