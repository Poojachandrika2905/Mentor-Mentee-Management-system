...
<div class="dashboard-card">
    <button class="btn1" onclick="toggleExperienceForm()">Add Education</button>
    ...
    <div style="margin-top: 30px;">
        ...
        <%
            try {
                ...
                PreparedStatement ps = con.prepareStatement("SELECT course_name, organization, duration FROM education WHERE mentor_username = ?");
