...
<div class="course-container">
    <div class="course-card">
        ...
        <a href="http://localhost:8080/MMS/course1.jsp" class="enroll-btn">select</a>
    </div>
    <div class="course-card">
        <img src="AIML.jpg" alt="Machine Learning" class="course-image">
        <p class="course-title">Machine Learning & AI</p>
        <a href="http://localhost:8080/MMS/course2.jsp" class="enroll-btn">select</a>
    </div>
    <div class="course-card">
    ...
    <div class="course-card">
        <img src="digitalmarketing.jpg" alt="Digital Marketing" class="course-image">
        <p class="course-title">Digital Marketing & SEO</p>
        <a href="#" class="enroll-btn">select</a>
    </div>
    <div class="course-card">
        <img src="uiux.jpg" alt="UI UX Design" class="course-image">
        <p class="course-title">UI/UX Design</p>
        <a href="#" class="enroll-btn">select</a>
    </div>
</div>
